...
import { EventService, Event } from '../../../libs/event-management/src/eventservice';
    ...
    <div className="container mx-auto p-8">
      <div className="bg-yellow-100 border-l-4 border-yellow-500 p-4 mb-6">
        <p className="text-yellow-700">
          <strong>Next.js Staging Environment</strong> - Event management with SDD architecture
        </p>
      </div>
      ...
      <div className="grid gap-6">
        {events.length === 0 ? (
          ...
          events.map((event) => (
            <div key={event.id} className="bg-white p-6 rounded-lg shadow border hover:shadow-lg transition-shadow">
      ...
      <div className="mt-8 text-center text-gray-500">
        ...
        <p className="text-sm">Using SDD Event Management Library</p>
      </div>
    </div>
  );
}
